This fork will be modified to run on the linux version of powershell (to be used with the <a href="https://github.com/metalstormbass/Offensive_Azure">Offensive Azure VM </a>a> 
